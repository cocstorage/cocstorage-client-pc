...
type IndexPopularStoragesProps = HTMLAttributes<HTMLDivElement>;

function IndexPopularStorages({ ...props }: IndexPopularStoragesProps) {
  return (
    <Flexbox direction="vertical" gap={30} customStyle={{ minWidth: 183 }} {...props}>
